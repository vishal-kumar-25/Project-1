...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud; PORT=30756; UID=xpl79034;PASSWORD=tifHyFInxWFAexGv; SECURITY=SSL;SSLServerCertificate = DigiCertGlobalRootCA.crt", "", "")
    ...
    if request.method=="POST":
       for x in range (1,5):
        ...
        if f.filename != '':
            ...
            COS_API_KEY_ID = "Mbapc8sxMSiSNWUFXScBLrwr_U29nfyvjyMwnIBrUUa9"
            COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/bf4ae3216a8b4474afd56a79bbeac925:5ae92e1c-0e1c-441c-b6e3-f33781c3c796::"
            ...
            cos.meta.client.upload_file(Filename= filepath,Bucket='vis-kumar',Key= u+x+".pdf")
...
def marksassign(stdname):
    ...
    COS_ENDPOINT = "https://s3.jp-tok.cloud-object-storage.appdomain.cloud"
    COS_API_KEY_ID = "Mbapc8sxMSiSNWUFXScBLrwr_U29nfyvjyMwnIBrUUa9"
    COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/bf4ae3216a8b4474afd56a79bbeac925::serviceid:ServiceId-2e263b1f-7406-40bd-9aef-2594d3dfad49"
